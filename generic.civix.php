 ...
 * extension.
 */
class CRM_Generic_ExtensionUtil {
  const SHORT_NAME = "generic";
  const LONG_NAME = "nl.roparun.generic";
  const CLASS_PREFIX = "CRM_Generic";
...
function _generic_civix_civicrm_entityTypes(&$entityTypes) {
